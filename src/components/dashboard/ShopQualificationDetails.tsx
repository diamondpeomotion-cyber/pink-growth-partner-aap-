...
export default function ShopQualificationDetails({
  ...
  return (
    <div className="bg-[#fcf9f8] text-[#1b1c1b] antialiased min-h-screen flex flex-col relative pb-20 font-sans max-w-lg mx-auto shadow-lg border-x border-gray-100">
