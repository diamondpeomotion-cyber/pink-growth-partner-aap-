  ...
  return (
    <div className="min-h-screen bg-[#f9f8f6] flex flex-col font-sans overflow-hidden">
      <header className="h-16 px-8 border-b border-gray-200/50 flex items-center justify-between bg-white/80 backdrop-blur-md sticky top-0 z-50">
        ...
        {/* No login/sign-up here by design: the onboarding runs inside the
            Growth Partner app and inherits its authenticated Supabase session. */}
        <div className="flex items-center gap-4">
          <span className="text-sm text-gray-500 hidden sm:inline">White Label · Website Onboarding</span>
        </div>
      </header>

      <main className="flex-1 max-w-[1280px] w-full mx-auto px-5 py-8 md:px-8 md:py-16 grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-center">
        {/* Left Column */}
        ...
        <div className="lg:col-span-7 relative h-[600px] w-full flex items-center justify-center lg:justify-end">
          ...
          <motion.div 
            ...
            className="w-full max-w-[700px] h-[360px] md:h-[500px] bg-white rounded-xl shadow-2xl border border-gray-200 flex flex-col overflow-hidden hover:rotate-0 transition-transform duration-500 origin-center"
          >
